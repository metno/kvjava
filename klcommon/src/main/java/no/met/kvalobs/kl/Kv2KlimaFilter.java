...
public class Kv2KlimaFilter {
	...
	static class FilterElem implements Comparable<FilterElem>{
		...
		public int compareTo(FilterElem obj) {
			return fdato.compareTo(obj.fdato);
		}
	}
	 ...
	 */
	public Kv2KlimaFilter(long stnr, long typeid){
		this.stnr=stnr;
		this.typeid=typeid;
		filterElemList.add( new FilterElem(null, 0 ) );
	}
	...
	public long       getStnr(){   return stnr;}
