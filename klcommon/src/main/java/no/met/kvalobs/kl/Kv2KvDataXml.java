...
public class Kv2KvDataXml {
	...
	{
		writeElem( element, Float.toString(value) );
	}
	
	void writeElemVal( String element, int value )throws XMLStreamException
	{
		writeElemVal( element, Integer.toString(value)  );	
	}
	
	void writeElemVal( String element, Long value )throws XMLStreamException
	{
		writeElemVal( element, Long.toString(value)  );	
	}
	
	void writeElemVal( String element, Instant val )throws XMLStreamException
	{
		writeElemVal( element, val.toString() );	
	}
