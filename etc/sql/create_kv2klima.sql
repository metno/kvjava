...
-- in no.met.kvalobs.kl.Kv2KlimaFilter, no.met.kvalobs.kl.ParamFilter and
-- no.met.kvalobs.kl.Filter.
--
-- NB NB NB !!!!!!!!!
...
CREATE ROLE kvdist  CREATEDB LOGIN PASSWORD 'kvdist';

CREATE DATABASE kvdist OWNER kvdist ENCODING UTF8;

\c kvdist


CREATE TABLE KLSYNOP (
 STNR        NUMERIC(12),
 DATO        TIMESTAMP,
 TYPEID      NUMERIC(4),
 PARAMID     NUMERIC(5),
...
CREATE INDEX I_KLSYNOP ON KV2KLIMA (STNR, DATO, TYPEID, PARAMID, SENSOR,
                                    XLEVEL, YEAR);


CREATE TABLE KLSYNOP_TEXT_DATA (
...
CREATE INDEX  I_KLSYNOP_TEXT_DATA ON KLSYNOP_TEXT_DATA (STATIONID, OBSTIME, PARAMID, TYPEID);
...
CREATE INDEX I_KLSVV ON KV2KLIMA (STNR, DATO, TYPEID, PARAMID, SENSOR,
                                    XLEVEL, YEAR);


CREATE TABLE KLSVV_TEXT_DATA (
 STATIONID NUMERIC(38),
 OBSTIME   TIMESTAMP,
 ORIGINAL  VARCHAR(200),
 PARAMID   NUMERIC(15),
...
CREATE INDEX  I_KLSVV_TEXT_DATA ON KLSVV_TEXT_DATA (STATIONID, OBSTIME, PARAMID, TYPEID);


CREATE TABLE KLFOREIGN (
 STNR        NUMERIC(12),
 DATO        TIMESTAMP,
 TYPEID      NUMERIC(4),
 PARAMID     NUMERIC(5),
...
CREATE INDEX I_KLFOREIGN ON KV2KLIMA (STNR, DATO, TYPEID, PARAMID, SENSOR,
                                    XLEVEL, YEAR);

CREATE TABLE KLFOREIGN_TEXT_DATA (
 STATIONID NUMERIC(38),
 OBSTIME   TIMESTAMP,
 ORIGINAL  VARCHAR(200),
 PARAMID   NUMERIC(15),
...
CREATE INDEX  I_KLFOREIGN_TEXT_DATA ON KLFOREIGN_TEXT_DATA (STATIONID, OBSTIME, PARAMID, TYPEID);
