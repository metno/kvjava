...
public class SendKv2KvData implements DataToKv, SendDataToKv {
    ...
    static Logger logger = Logger.getLogger(SendKv2KvData.class);
    ...
    private class MyDataToKv implements no.met.kvalobs.kl2kv.DataToKv{
		...
		public boolean sendData(String data, long stationid, long typeid)  {
			...
			if( dryRun ) {
				System.out.println("kv2kvDecoder\n" + data);
				return true;
			}
     ...
     */
    public SendKv2KvData(Kl2KvApp app, DataToKv dataToKv, Boolean dryRun){
    	obsCount=0;
    	msgCount=0;
    ...
    public SendKv2KvData(Kl2KvApp app, Boolean dryRun){
    ...
    public boolean sendDataToKv(String sTypeid, Station[] stations, List<TimeRange> obstimes, 
    	...
    	dh=new Kv2KvDataHelper(con,this,sTypeid, obstimes, disableQC1, app.getTablename());
